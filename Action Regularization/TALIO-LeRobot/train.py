...
def prepare_dataset(config: dict) -> torch.utils.data.Dataset:
    ...
    if dataset_type == "lerobot":
        from dataset.lerobot_dataset_pretrain_mp import LeRobotDataset, TALIOCompressedLeRobotDataset 
        import yaml
        ...
        dataset = TALIOCompressedLeRobotDataset(
            ...
            talio_json_path="dataset/LIBERO_unsupervised_sub_skills.json"
        )
    else:
